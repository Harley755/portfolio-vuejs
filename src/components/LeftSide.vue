...
import GithubIcon from "./socialIcon/GithubIcon.vue";
import TwitterIcon from "./socialIcon/TwitterIcon.vue";
</script>
    ...
    <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
      <li class="mr-5 text-xs">
        <a
          ...
          href="https://github.com/beryl452"
          target="_blank"
          rel="noreferrer"
      ...
      <li class="mr-5 text-xs">
        <a
          class="block hover:text-slate-200"
          href="https://twitter.com/Bryl_07"
          target="_blank"
          rel="noreferrer"
      ...
      <li class="mr-5 text-xs">
        <a
          class="block hover:text-slate-200"
          href="https://www.linkedin.com/in/berylhouessou/"
          target="_blank"
          rel="noreferrer"
      ...
      <li class="mr-5 text-xs">
        <a
          class="block hover:text-slate-200"
          href="https://github.com/beryl-07"
          target="_blank"
          rel="noreferrer"
          ><span class="sr-only">GitHub</span
          ><svg
