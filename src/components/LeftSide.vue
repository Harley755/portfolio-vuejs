        ...
        <ul class="mt-16 w-max">
          ...
          <li>
            <a id="experienceMenu" href="#experience" class="group flex items-center py-3"
              ...
              <span
                class="experienceChild nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">Experiences</span>
            </a>
          </li>
          <li>
